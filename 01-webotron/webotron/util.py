"""Contains some utility information for webotron."""
...
region_to_endpoint = {
    ...
    "us-west-2": Endpoint("US West (Oregon)",
                          ...
                          "Z3BJ6K6RIION7M"),
    "af-south-1": Endpoint("Africa (Cape Town)",
                           "s3-website.af-south-1.amazonaws.com",
                           "Z11KHD8FBVPUYU"),
    "ap-east-1": Endpoint("Asia Pacific (Hong Kong)",
    ...
    "cn-northwest-1": Endpoint("China (Ningxia)",
                               ...
                               "Not supported"),
    "eu-central-1": Endpoint("Europe (Frankfurt)",
                             "s3-website.eu-central-1.amazonaws.com",
                             "Z21DNDUVLTQW6Q"),
    "eu-west-1": Endpoint("Europe (Ireland)",
                          "s3-website-eu-west-1.amazonaws.com",
                          "Z1BKCTXD74EZPE"),
    "eu-west-2": Endpoint("Europe (London)",
                          "s3-website.eu-west-2.amazonaws.com",
                          "Z3GKZC51ZF0DB4"),
    "eu-south-1": Endpoint("Europe (Milan)",
                           "s3-website.eu-south-1.amazonaws.com",
                           "Z3IXVV8C73GIO3"),
    "eu-west-3": Endpoint("Europe (Paris)",
                          "s3-website.eu-west-3.amazonaws.com",
                          "Z3R1K369G5AVDG"),
    "eu-north-1": Endpoint("Europe (Stockholm)",
